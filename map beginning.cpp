...
keyal rakbe aikane key er ascending order e mane key aikane string tie string er lexicographical order e store hbe mane oita 
maintain hbe aikane always*/
}
